export const chatPageStyles = {
    ...
    notExpandedIconButton: {
        ...
        color: '#fff',
        borderRadius: '50%',
        '&:hover': { bgcolor: '#6C64E1', boxShadow: '0 0px 12px rgba(163, 144, 238, 0.6)'},
    },
    expandedBox: {
        height: '100%',
        px: 2,
    ...
    cancelIconButton: {
        ...
        width: 48,
        height: 48,
        '&:hover': { color: '#ffffff', bgcolor: '#ff4141', boxShadow: '0 0px 12px rgba(163, 144, 238, 0.6)'},
    },
    dialogPaper: {
        background: 'rgba(115,113,119,0.2)',
